...
export default function Page() {
  ...
  return (
    ...
    <Link
      href="/"
      className="no-print fixed left-4 top-4 z-50 rounded-full border border-white/15 bg-black/30 px-3 py-1.5 font-mono text-xs text-slate-300 backdrop-blur transition-colors hover:text-white"
    >
      ← Jasper home
    </Link>
    <SmoothScroll>
